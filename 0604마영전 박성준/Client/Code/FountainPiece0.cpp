...
CFountainPiece0::CFountainPiece0(LPDIRECT3DDEVICE9 pGraphicDev)
...
CFountainPiece0::~CFountainPiece0(void)
{

}

HRESULT CFountainPiece0::Ready_GameObject()
{
	FAILED_CHECK_RETURN(Add_Component(), E_FAIL);
	m_pTransformCom->m_vInfo[Engine::INFO_POS] = { 0.f,0.9f ,1.f }; //생성되는 위치. 이거 잘조절
...
_int CFountainPiece0::Update_GameObject(const _float& fTimeDelta)
{
	...
	_vec3 Dest{ 0.f,0.f,-25.f }; //목적지인데 이거 클수록 더 멀리,빨리나감 .이거 x랑 z만 조절 하자
...
void CFountainPiece0::Render_GameObject(void)
{
...
void CFountainPiece0::Free(void)
{
	Engine::CGameObject::Free();
}

HRESULT CFountainPiece0::Add_Component(void)
{
...
CFountainPiece0* CFountainPiece0::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CFountainPiece0*	pInstance = new	CFountainPiece0(pGraphicDev);
