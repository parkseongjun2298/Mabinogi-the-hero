...
CFountainPiece1::CFountainPiece1(LPDIRECT3DDEVICE9 pGraphicDev)
...
CFountainPiece1::~CFountainPiece1(void)
{

}

HRESULT CFountainPiece1::Ready_GameObject()
{
	FAILED_CHECK_RETURN(Add_Component(), E_FAIL);
	m_pTransformCom->m_vInfo[Engine::INFO_POS] = { 1.f,0.4f ,1.f }; //생성되는 위치. 이거 잘조절
...
_int CFountainPiece1::Update_GameObject(const _float& fTimeDelta)
{
...
void CFountainPiece1::Render_GameObject(void)
{
...
void CFountainPiece1::Free(void)
{
	Engine::CGameObject::Free();
}

HRESULT CFountainPiece1::Add_Component(void)
{
...
CFountainPiece1* CFountainPiece1::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CFountainPiece1*	pInstance = new	CFountainPiece1(pGraphicDev);
