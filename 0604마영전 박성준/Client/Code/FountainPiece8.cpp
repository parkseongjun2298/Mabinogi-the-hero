...
CFountainPiece8::CFountainPiece8(LPDIRECT3DDEVICE9 pGraphicDev)
...
CFountainPiece8::~CFountainPiece8(void)
{

}

HRESULT CFountainPiece8::Ready_GameObject()
{
	FAILED_CHECK_RETURN(Add_Component(), E_FAIL);
	m_pTransformCom->m_vInfo[Engine::INFO_POS] = { -0.8f,0.3f ,1.f }; //생성되는 위치. 이거 잘조절
...
_int CFountainPiece8::Update_GameObject(const _float& fTimeDelta)
{
...
void CFountainPiece8::Render_GameObject(void)
{
...
void CFountainPiece8::Free(void)
{
	Engine::CGameObject::Free();
}

HRESULT CFountainPiece8::Add_Component(void)
{
...
CFountainPiece8* CFountainPiece8::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CFountainPiece8*	pInstance = new	CFountainPiece8(pGraphicDev);
