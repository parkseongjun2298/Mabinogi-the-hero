...
CFountainPiece4::CFountainPiece4(LPDIRECT3DDEVICE9 pGraphicDev)
...
CFountainPiece4::~CFountainPiece4(void)
{

}

HRESULT CFountainPiece4::Ready_GameObject()
{
	FAILED_CHECK_RETURN(Add_Component(), E_FAIL);
	m_pTransformCom->m_vInfo[Engine::INFO_POS] = { -1.1f,0.1f ,1.f }; //생성되는 위치. 이거 잘조절
...
_int CFountainPiece4::Update_GameObject(const _float& fTimeDelta)
{
	...
	_vec3 Dest{ -15.f,0.f,-30.f }; //목적지인데 이거 클수록 더 멀리,빨리나감 .이거 x랑 z만 조절 하자
...
void CFountainPiece4::Render_GameObject(void)
{
...
void CFountainPiece4::Free(void)
{
	Engine::CGameObject::Free();
}

HRESULT CFountainPiece4::Add_Component(void)
{
...
CFountainPiece4* CFountainPiece4::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CFountainPiece4*	pInstance = new	CFountainPiece4(pGraphicDev);
