...
CLordOfManaBotEffect2::CLordOfManaBotEffect2(LPDIRECT3DDEVICE9 pGraphicDev)
...
CLordOfManaBotEffect2::~CLordOfManaBotEffect2(void)
{

}

HRESULT CLordOfManaBotEffect2::Ready_GameObject(void)
{
...
_int CLordOfManaBotEffect2::Update_GameObject(const _float& fTimeDelta)
{
	if (m_bDead)
		return DEAD_OBJ;
...
void CLordOfManaBotEffect2::Render_GameObject(void)
{
...
void CLordOfManaBotEffect2::Free(void)
{
	Engine::CGameObject::Free();
}

HRESULT CLordOfManaBotEffect2::Add_Component(void)
{
...
HRESULT CLordOfManaBotEffect2::SetUp_ConstantTable(LPD3DXEFFECT & pEffect)
{
...
CLordOfManaBotEffect2* CLordOfManaBotEffect2::Create(LPDIRECT3DDEVICE9 pGraphicDev,_vec3 PlayerPos)
{
	CLordOfManaBotEffect2*	pInstance = new	CLordOfManaBotEffect2(pGraphicDev);
