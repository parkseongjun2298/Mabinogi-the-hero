...
CFountainPiece7::CFountainPiece7(LPDIRECT3DDEVICE9 pGraphicDev)
...
CFountainPiece7::~CFountainPiece7(void)
{

}

HRESULT CFountainPiece7::Ready_GameObject()
{
	FAILED_CHECK_RETURN(Add_Component(), E_FAIL);
	m_pTransformCom->m_vInfo[Engine::INFO_POS] = { 0.2f,0.4f ,1.f }; //생성되는 위치. 이거 잘조절
...
_int CFountainPiece7::Update_GameObject(const _float& fTimeDelta)
{
	...
	_vec3 Dest{ -20.f,0.f,-30.f }; //목적지인데 이거 클수록 더 멀리,빨리나감 .이거 x랑 z만 조절 하자
...
void CFountainPiece7::Render_GameObject(void)
{
...
void CFountainPiece7::Free(void)
{
	Engine::CGameObject::Free();
}

HRESULT CFountainPiece7::Add_Component(void)
{
...
CFountainPiece7* CFountainPiece7::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CFountainPiece7*	pInstance = new	CFountainPiece7(pGraphicDev);
