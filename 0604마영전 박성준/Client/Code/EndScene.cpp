...
HRESULT CEndScene::Ready_GameObject(void)
{
...
_int CEndScene::Update_GameObject(const _float& fTimeDelta)
{
...
void CEndScene::Render_GameObject(void)
{
...
HRESULT CEndScene::Add_Component(void)
{
	...
	// texture
	pComponent = m_pTextureCom = dynamic_cast<Engine::CTexture*>(Engine::Clone(RESOURCE_STATIC, L"Texture_Ending"));
	NULL_CHECK_RETURN(pComponent, E_FAIL);
...
HRESULT CEndScene::SetUp_ConstantTable(LPD3DXEFFECT& pEffect)
{
