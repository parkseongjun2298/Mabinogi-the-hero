...
CFountainPiece6::CFountainPiece6(LPDIRECT3DDEVICE9 pGraphicDev)
...
CFountainPiece6::~CFountainPiece6(void)
{

}

HRESULT CFountainPiece6::Ready_GameObject()
{
	FAILED_CHECK_RETURN(Add_Component(), E_FAIL);
	m_pTransformCom->m_vInfo[Engine::INFO_POS] = { -1.f,0.5f ,1.f }; //생성되는 위치. 이거 잘조절
...
_int CFountainPiece6::Update_GameObject(const _float& fTimeDelta)
{
...
void CFountainPiece6::Render_GameObject(void)
{
...
void CFountainPiece6::Free(void)
{
	Engine::CGameObject::Free();
}

HRESULT CFountainPiece6::Add_Component(void)
{
...
CFountainPiece6* CFountainPiece6::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CFountainPiece6*	pInstance = new	CFountainPiece6(pGraphicDev);
