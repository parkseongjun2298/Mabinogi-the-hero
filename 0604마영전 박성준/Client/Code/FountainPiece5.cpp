...
CFountainPiece5::CFountainPiece5(LPDIRECT3DDEVICE9 pGraphicDev)
...
CFountainPiece5::~CFountainPiece5(void)
{

}

HRESULT CFountainPiece5::Ready_GameObject()
{
	FAILED_CHECK_RETURN(Add_Component(), E_FAIL);
	m_pTransformCom->m_vInfo[Engine::INFO_POS] = { 1.2f,0.1f ,1.f }; //생성되는 위치. 이거 잘조절
...
_int CFountainPiece5::Update_GameObject(const _float& fTimeDelta)
{
...
void CFountainPiece5::Render_GameObject(void)
{
...
void CFountainPiece5::Free(void)
{
	Engine::CGameObject::Free();
}

HRESULT CFountainPiece5::Add_Component(void)
{
...
CFountainPiece5* CFountainPiece5::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CFountainPiece5*	pInstance = new	CFountainPiece5(pGraphicDev);
