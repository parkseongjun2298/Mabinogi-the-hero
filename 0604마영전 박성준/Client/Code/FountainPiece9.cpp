...
CFountainPiece9::CFountainPiece9(LPDIRECT3DDEVICE9 pGraphicDev)
...
CFountainPiece9::~CFountainPiece9(void)
{

}

HRESULT CFountainPiece9::Ready_GameObject()
{
...
_int CFountainPiece9::Update_GameObject(const _float& fTimeDelta)
{
	...
	_vec3 Dest{ 0.f,0.f,-30.f }; //목적지인데 이거 클수록 더 멀리,빨리나감 .이거 x랑 z만 조절 하자
...
void CFountainPiece9::Render_GameObject(void)
{
...
void CFountainPiece9::Free(void)
{
	Engine::CGameObject::Free();
}

HRESULT CFountainPiece9::Add_Component(void)
{
...
CFountainPiece9* CFountainPiece9::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CFountainPiece9*	pInstance = new	CFountainPiece9(pGraphicDev);
