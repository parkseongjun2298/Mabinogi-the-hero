...
HRESULT CPlayerHp::Ready_GameObject(void)
{
...
void CPlayerHp::Render_GameObject(void)
{
...
void CPlayerHp::Free(void)
{
	Engine::CGameObject::Free();
}

HRESULT CPlayerHp::Add_Component(void)
{
	...
	// texture
	pComponent = m_pTextureCom = dynamic_cast<Engine::CTexture*>(Engine::Clone(RESOURCE_STATIC, L"Texture_PlayerHpBar_Value"));
	NULL_CHECK_RETURN(pComponent, E_FAIL);
