...
CFountainPiece3::CFountainPiece3(LPDIRECT3DDEVICE9 pGraphicDev)
...
CFountainPiece3::~CFountainPiece3(void)
{

}

HRESULT CFountainPiece3::Ready_GameObject()
{
	FAILED_CHECK_RETURN(Add_Component(), E_FAIL);
	m_pTransformCom->m_vInfo[Engine::INFO_POS] = { -1.f,0.1f ,1.f }; //생성되는 위치. 이거 잘조절
...
_int CFountainPiece3::Update_GameObject(const _float& fTimeDelta)
{
	...
	_vec3 Dest{ -10.f,0.f,-25.f }; //목적지인데 이거 클수록 더 멀리,빨리나감 .이거 x랑 z만 조절 하자
...
void CFountainPiece3::Render_GameObject(void)
{
...
void CFountainPiece3::Free(void)
{
	Engine::CGameObject::Free();
}

HRESULT CFountainPiece3::Add_Component(void)
{
...
CFountainPiece3* CFountainPiece3::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CFountainPiece3*	pInstance = new	CFountainPiece3(pGraphicDev);
